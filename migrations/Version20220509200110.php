 ...
 */
final class Version20220509200110 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE posts ADD pseudo VARCHAR(255) DEFAULT NULL, ADD email VARCHAR(255) DEFAULT NULL, CHANGE image image VARCHAR(255) NOT NULL');
    }
