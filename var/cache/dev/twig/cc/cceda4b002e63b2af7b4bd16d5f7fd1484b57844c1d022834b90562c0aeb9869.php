...
/* tag/index.html.twig */
class __TwigTemplate_efaab486324d487fb6baede3df001c89d99cec0b0714f52a2ab4a3ea0750615b extends Template
{
    private $source;
    private $macros = [];
...
<div class=\"example-wrapper\">
    ...
    ";
        ...
        $context['_seq'] = twig_ensure_traversable((isset($context["tag"]) || array_key_exists("tag", $context) ? $context["tag"] : (function () { throw new RuntimeError('Variable "tag" does not exist.', 12, $this->source); })()));
...
";
    ...
    {
        return array (  116 => 17,  103 => 15,  100 => 13,  96 => 12,  88 => 6,  78 => 5,  59 => 3,  36 => 1,);
    }
...
{% block title %}Tout les tags{% endblock %}
...
<div class=\"example-wrapper\">
    ...
    {% for tags in tag %}
        ...
        {# <li><a class=\" {{\"type#{tags.couleur}\"}}\" href=\"{{path('tag_show', {slug: tags.slug})}}\">{{tags.nom}}</a></li> #}
  <a href=\"{{path('tag_show', {slug: tags.slug})}}\" {{tags.nom}}<button type=\"button\" class=\"btn btn-outline-primary\">{{tags.nom}}</button> </a>
        {% endfor %}
    </ul>
</div>
{% endblock %}
", "tag/index.html.twig", "/Users/admin/Desktop/codeinfo/templates/tag/index.html.twig");
    }
}
