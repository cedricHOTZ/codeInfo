...
<h2 class=\"text-white text-center\">PHP</h2>
  ...
  <h4 class=\"text-white\">Categories</h2>\t
    ...
    <h5 class=\"card-title\">";
            // line 157
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["postPertinents"], "titre", [], "any", false, false, false, 157), "html", null, true);
            echo "</h5>
     <h5 class=\"card-text\">";
            // line 158
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["postPertinents"], "description", [], "any", false, false, false, 158), "html", null, true);
            echo "</h5>
     <a href=\"";
            // line 159
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["postPertinents"], "url", [], "any", false, false, false, 159), "html", null, true);
   ...
   ";
        ...
        <div class=\"col-md-2\">
          ...
          <div class=\"card shadow-sm\">
             ...
             <img src=\"";
                // line 187
                echo twig_escape_filter($this->env, ((twig_get_attribute($this->env, $this->source, $context["postflutters"], "image", [], "any", false, false, false, 187)) ? ($this->extensions['Liip\ImagineBundle\Templating\FilterExtension']->filter($this->extensions['Vich\UploaderBundle\Twig\Extension\UploaderExtension']->asset(($context["post"] ?? null), "imageFile"), "square_thumbnail_medium")) : ($this->extensions['Liip\ImagineBundle\Templating\FilterExtension']->filter($this->extensions['Symfony\Bridge\Twig\Extension\AssetExtension']->getAssetUrl("/images/posts/header.jpg"), "square_thumbnail_medium"))), "html", null, true);
                echo "\" class=\"card-img-top\" alt=\"\">
            ";
                // line 189
                echo "
            <div class=\"card-body\">
                <p class=\"card-text\">";
                // line 191
                echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["postflutters"], "titre", [], "any", false, false, false, 191), "html", null, true);
                echo "</p>
           <p class=\"card-text\">";
                // line 192
                echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["postflutters"], "description", [], "any", false, false, false, 192), "html", null, true);
                echo "</p>   
              <div class=\"d-flex justify-content-between align-items-center\">
                <div class=\"btn-group\">
                    ";
                // line 195
                $context['_parent'] = $context;
                $context['_seq'] = twig_ensure_traversable(twig_get_attribute($this->env, $this->source, $context["postflutters"], "getTags", [], "method", false, false, false, 195));
                foreach ($context['_seq'] as $context["_key"] => $context["tags"]) {
                    echo "   
                  <span class=\"badge bg-light text-dark tagCarte\">";
                    // line 196
                    echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["tags"], "nom", [], "any", false, false, false, 196), "html", null, true);
                    echo "</span>
                    ";
                }
                $_parent = $context['_parent'];
                ...
                echo "   
                    <a href=\"";
                // line 198
                echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["postflutters"], "url", [], "any", false, false, false, 198), "html", null, true);
                echo " \"target=\"_blank\">
                 <span class=\"badge rounded-pill bg-dark text-white\">Voir plus</span>
                  </a>
                </div>
