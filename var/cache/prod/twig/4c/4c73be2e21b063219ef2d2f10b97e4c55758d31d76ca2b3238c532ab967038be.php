...
class __TwigTemplate_f435ef457893acacfe90a57ed350bf2f4f14b7b5eae67262e15169eb09df5e92 extends Template
{
    private $source;
    private $macros = [];
...
<h1>Inscription</h1>
    ...
    ";
        ...
        ";
        // line 16
        echo $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock(twig_get_attribute($this->env, $this->source, ($context["registrationForm"] ?? null), "password", [], "any", false, false, false, 16), 'row');
        echo "
        ";
        // line 17
        echo $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock(twig_get_attribute($this->env, $this->source, ($context["registrationForm"] ?? null), "agreeTerms", [], "any", false, false, false, 17), 'row', ["label" => "Veuillez accépter les conditions d'utilisation"]);
        echo "
...
";
    ...
    {
        return array (  92 => 20,  86 => 17,  82 => 16,  78 => 15,  74 => 14,  70 => 13,  66 => 12,  58 => 6,  54 => 5,  47 => 3,  36 => 1,);
    }

    public function getSourceContext()
    {
        return new Source("", "registration/register.html.twig", "/Users/admin/Desktop/codeinfo/templates/registration/register.html.twig");
    }
}
